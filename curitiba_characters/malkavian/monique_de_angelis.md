...
- **Generation**: 11th  
- **Role**: Socialite, gossip broker, chaos catalyst  

#### 🧩 Profile
- In life, Monique was a **cocaine addict**. In undeath, she seeks out **users of the drug** to feed from.
- When she drinks vitae tainted with cocaine, it triggers **unpredictable side effects**:
  - **Paranoia**, **psychotic breaks**, and **hallucinations** — sometimes visual, sometimes auditory.
  - These episodes may be **drug-induced**, **delusional**, or **genuinely supernatural** (e.g., spirits or echoes). She never knows which.
